...
Public Class Users
    ...
    Public Property Email_pegawaiProperty() As String
        Get
            Return email
        End Get
        Set(ByVal value As String)
    ...
    Public Function AddUsersDatabase(username_regist As String,
        ...
        Try
          ...
          + "password=" + password + ";" + "database =" + database
            ...
            sqlQuery = "INSERT INTO USERS( username, password, registered_at, dir_foto, id_pegawai, nama_pegawai, email, jabatan, kode_akses) VALUE('" _
                        & username_regist & "', '" _
    ...
    Public Function AksesPemulihan(username_reset As String, nama_pegawai_reset As String, email_reset As String, kode_akses_reset As String) As List(Of String)
        ...
        Try
          ...
          + "password=" + password + ";" + "database =" + database
            ...
            Dim queryAuth = "SELECT id_user FROM users
                            WHERE username='" & username_reset & "' AND nama_pegawai='" & nama_pegawai_reset & "' AND email='" & email_reset & "' AND kode_akses='" & kode_akses_reset & "'"
