Public Class Login
    ...
    Public Shared pergudangan As Pergudangan
    Public Shared pergudangan_readOnly As Pergudangan_ReadOnly
    ...
    Public Sub New()
        ...
        users = New Users()
        pergudangan_readOnly = New Pergudangan_ReadOnly()
    End Sub
    ...
    Private Sub BtnLihatSaja_Click(sender As Object, e As EventArgs) Handles BtnLihatSaja.Click
        MessageBox.Show("Akses Gudang Berhasil!")
        pergudangan_readOnly.Show()
        Me.Hide()
    End Sub
